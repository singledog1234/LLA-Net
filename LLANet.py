...
from medseg.utils.models.Window_attention import WindowAttention
...
class LLANet(nn.Module):
    def __init__(self, num_classes, input_channels=3, deep_supervision=False, img_size=224,
        ...
        self.rfb=LightRFB(embed_dims[0],8,embed_dims[0])
        self.rfb2=LightRFB(embed_dims[1],16,embed_dims[1])
        self.rfb3=LightRFB(embed_dims[2],32,embed_dims[2])
        self.rfb4=LightRFB(embed_dims[3],64,embed_dims[3])
